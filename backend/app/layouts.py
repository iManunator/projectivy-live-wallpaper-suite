...
PRESETS: dict[str, Layout] = {
    ...
    "Prime Cinematic": Layout(
        ...
        layers=_layers(
            ...
            {"id": "watch", "slot": "watch_status", "x": 220, "y": 778, "font_size": 22},
    ...
    "Google TV Clean": Layout(
        ...
        layers=_layers(
            ...
            {"id": "watch", "slot": "watch_status", "x": 72, "y": 252, "font_size": 20},
            {"id": "overview", "slot": "overview", "x": 72, "y": 310, "width": 640, "font_size": 22, "color": "#e8e8e8"},
        ),
    ),
    "Status Focus": Layout(
        name="Status Focus",
    ...
    "Projectivy Dock": Layout(
        ...
        layers=_layers(
            ...
            {"id": "watch", "slot": "watch_status", "x": 220, "y": 284, "font_size": 22},
