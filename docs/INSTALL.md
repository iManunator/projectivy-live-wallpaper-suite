...
| **Container** | [`ghcr.io/imanunator/wallpaparr`](https://github.com/iManunator/projectivy-live-wallpaper-suite/pkgs/container/wallpaparr) (`:latest` from `main`, `:1.2.2` from tag `v1.2.2`) |
...
**Do not retag earlier versions.** After 1.2.2 is on `main`, tag `v1.2.2` so Release + GHCR publish `wallpaparr-plugin-release.apk` and `:v1.2.2` / `:1.2.2` / `:latest`.
...
# or ghcr.io/imanunator/wallpaparr:1.2.2
