...
**Primary:** GitHub **Release** asset [`wallpaparr-plugin-release.apk`](https://github.com/iManunator/projectivy-live-wallpaper-suite/releases/latest/download/wallpaparr-plugin-release.apk) (tag `v1.2.1` after it is published). See [RELEASE.md](RELEASE.md).
